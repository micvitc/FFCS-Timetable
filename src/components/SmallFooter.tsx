...
export default function SmallFooter() {
    return (
        <footer className="w-full mt-auto py-10 flex justify-center px-4 sm:px-6 shrink-0 select-none">
            <div className="w-full max-w-6xl bg-white/70 backdrop-blur-md border border-[#eadcc5]/85 rounded-3xl p-5 sm:p-6 shadow-[0_12px_40px_rgba(74,54,30,0.03)] flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <div className="text-[11px] font-black text-gray-500 tracking-widest uppercase flex flex-wrap items-center justify-center gap-2">
                    ...
                    <a 
                        ...
                        className="inline-flex items-center px-3.5 py-1.5 bg-[#3B5BDB]/8 hover:bg-[#3B5BDB]/15 text-[#3B5BDB] rounded-xl font-extrabold transition-all shadow-sm active:scale-95 duration-200"
                    >
